                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" placeholder="" value="{{ $page->title }}" class="form-control"
                                id="name">
                            <input type="hidden" name="id" value="{{ $page->id }}">
                        </div>
                        <div class="mb-4">
                            <label for="product_title" class="form-label">Seo Meta Title</label>
                            <input type="text" value="{{ $page->meta_title }}" name="meta_title" placeholder="" class="form-control" id="">
                        </div>
                        <div class="mb-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <textarea name="content" id="" class="form-control tinymce" cols="30" rows="30">{!! $page->content !!}</textarea>
                        </div>
